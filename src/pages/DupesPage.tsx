      ...
      <main className="container mx-auto px-4 py-12">
        <div className="max-w-7xl mx-auto">
          <motion.div
            ...
            className="mb-14 mt-8 text-center"
          >
          ...
          <div className="flex justify-center mb-10">
            <Tabs defaultValue={selectedCategory} onValueChange={handleCategoryChange} className="w-full max-w-2xl mx-auto">
              <TabsList className="bg-white/50 backdrop-blur-sm p-1 rounded-full border border-gray-100 shadow-sm w-full flex justify-center">
                {categories.map((category) => (
                  <TabsTrigger
                    key={category.id}
                    value={category.id}
                    className="rounded-full px-5 py-2 data-[state=active]:bg-gray-100 data-[state=active]:text-gray-800"
                  >
                    {category.name}
                  </TabsTrigger>
                ))}
          ...
          {isLoading ? (
            <div className="flex justify-center items-center p-12">
              ...
              <span className="ml-4 text-lg text-gray-800">Loading dupes...</span>
            </div>
          ) : isError ? (
